...
file_path = r"c:\Users\Divyam Kulshrestha\Desktop\BomRouter\data\raw_excel\1777550366723-UP HB REVISED PTT WEF 01.05.2026.xlsx"
out_path = r"c:\Users\Divyam Kulshrestha\Desktop\BomRouter\data\extracted\harbour_up.csv"
stations_path = r"c:\Users\Divyam Kulshrestha\Desktop\BomRouter\data\extracted\harbour_up_stations.txt"
...
for idx, row in df.iterrows():
    ...
    # Skip overarching headers
    if "PANVEL" in col0_val.upper() and ("CSMT" in col0_val.upper() or "GOREGAON" in col0_val.upper()):
        continue
