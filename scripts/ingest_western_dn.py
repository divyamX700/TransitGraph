...
file_path = r"c:\Users\Divyam Kulshrestha\Desktop\BomRouter\data\raw_excel\1777701123504-DN PTT W.E.F. 01.05.2026.xlsx"
out_path = r"c:\Users\Divyam Kulshrestha\Desktop\BomRouter\data\extracted\western_dn.csv"
stations_path = r"c:\Users\Divyam Kulshrestha\Desktop\BomRouter\data\extracted\western_dn_stations.txt"
...
for idx, row in df.iterrows():
    ...
    if col0_val.upper().startswith('STATION'):
        train_columns = {}
        for col_idx in range(1, len(row)):
            val = str(row[col_idx]).strip()
            if val != 'nan' and val != '':
                # E.g. "DRD 93001\n12 CAR" -> "DRD 93001" -> "93001"
